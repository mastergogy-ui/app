    ...
    <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Manrope' }}>Create Account</h1>
          <p className="text-gray-500">Join RENT WALA and start earning</p>
        </div>
