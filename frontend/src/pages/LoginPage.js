...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    ...
    const redirectUrl = window.location.origin + (from === '/dashboard' ? '/dashboard' : from);
    ...
    <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Manrope' }}>Welcome Back</h1>
          <p className="text-gray-500">Login to continue to RENT WALA</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <div className="mt-6">
            ...
            <Button
              ...
              variant="outline"
              className="w-full h-12 rounded-full mt-4 border-gray-200 font-semibold"
            >
